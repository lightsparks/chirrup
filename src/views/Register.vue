    ...
    <div class="register">
        ...
        <form class="container_column">
            ...
            <div class="container_column">
                <label for="input_register_first_name" class="input_container">First name:</label>
                <input
            ...
            <div class="container_column">
                <label for="input_register_last_name" class="input_container">Last name:</label>
                <input
            ...
            <div class="container_column">
                <label for="input_register_email" class="input_container">Email address:</label>
                <input
                        v-model="reg_user.email"
                        type="email" id="input_register_email"
                        class="input_container"
            ...
            <div class="container_column">
                <label for="input_register_password" class="input_container">Password:</label>
                <input
            ...
            <div class="container_column">
                <label for="input_register_password_confirmation" class="input_container">Re-type password:</label>
                <input
...
<style type=text/css src="./Register.css" scoped></style>
